         ...
         $(this).parents("form").validate({
            ...
            submitHandler:function(form){
                ...
                $.ajax({
                    ...
                    data: "html",
                    beforeSend:function(){
                        $(".vidget-application").addClass("process");
                        $(".submit").addClass("btn--loading");
                    },
                    success: function(){
                                       
                        $(".vidget-application").find("form").addClass("hidden");
                        $(".b-success-massage").addClass("visible");
                        $(".vidget-application").removeClass("process");
