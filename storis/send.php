<?php
    ...
    $subdomain='dcode';
    $responsible_user_id = '2876713'; //id ответственного по сделке, контакту, компании
    $lead_name = 'Заявка с сайта'; //Название добавляемой сделки
    $lead_status_id = '1772830'; //id этапа продаж, куда помещать сделку
    
    $contact_name = $name = $_POST['name'];; //Название добавляемого контакта
    $contact_phone = $phone = $_POST['phone'];; //Телефон контакта
    $contact_email = 'mail@mail.com'; //Емейл контакта



    //АВТОРИЗАЦИЯ
    $user=array(
      'USER_LOGIN'=>'ruslan@dcode.team',
      'USER_HASH'=>'dbb4428dd296b611f9c4099b22162c89b3cf9591'
    );
